                ...
                <div className="relative z-20 w-full h-full p-20 flex flex-col justify-between">
                    ...
                    >
                        ...
                        <div className="flex space-x-4">
                            <span className="px-3 py-1 bg-surface-main/30 backdrop-blur-md rounded-full text-[9px] text-text-muted font-black uppercase tracking-widest border border-border-subtle">Enterprise Grade</span>
                            <span className="px-3 py-1 bg-surface-main/30 backdrop-blur-md rounded-full text-[9px] text-text-muted font-black uppercase tracking-widest border border-border-subtle">Secure Portal</span>
                        </div>
                    </motion.div>
            ...
            <div className="w-full lg:w-2/5 relative flex flex-col justify-between bg-[#FDFDFD] overflow-y-auto">
                <div className="p-12 md:p-20 flex-1 flex flex-col justify-center">
                    ...
                    >
                        ...
                        <div className="relative flex p-2 bg-surface-main rounded-[2rem] mb-12 border border-border-subtle shadow-inner overflow-hidden">
                            {roles.map((r) => (
                                <button
                                    key={r.id}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10">
                            ...
                            <div className="space-y-8">
                                <div className="group space-y-2">
                                    ...
                                    <div className="flex items-center space-x-4 border-b-2 border-border-subtle focus-within:border-primary-500 transition-all duration-300 pb-3">
                ...
                <footer className="bg-surface-main/30 border-t border-border-subtle p-12 grid grid-cols-1 md:grid-cols-3 gap-12 text-[10px] font-black text-text-muted uppercase tracking-[0.2em]">
