                        ...
                        <DashboardCard className="h-[500px] flex flex-col group relative">
                            <div className="flex items-center justify-between mb-10">
                                ...
                                <select
                                    ...
                                    className="bg-surface-main border-border-subtle rounded-xl px-4 py-2 text-xs font-bold text-text-secondary focus:ring-4 focus:ring-primary-500/10 outline-none cursor-pointer"
                                >
