                ...
                {loading ? (
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="text-[10px] font-black text-text-muted uppercase tracking-widest border-b border-edu-border bg-surface-main/20">
                                        ...
                                        <tr key={i} className="hover:bg-surface-main/50 transition-colors group">
                                            ...
                                            <td className="px-6 py-4 w-40">
                                                <div className="flex items-center gap-3">
                                                    <div className="flex-1 h-2 rounded-full bg-surface-main overflow-hidden border border-edu-border">
...
const UploadMarks = () => {
    ...
    return (
        <div className="space-y-4">
            {/* Exam Info */}
            <div className="bg-surface-card rounded-[2rem] shadow-premium p-8 border border-edu-border grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-surface-main border border-edu-border rounded-xl px-4 py-2 text-sm text-text-primary focus:ring-4 focus:ring-primary-500/10 outline-none transition-all placeholder:text-text-muted/50"
                    />
                </div>
                <div>
                    ...
                    <select
                        ...
                        className="w-full bg-surface-main border border-edu-border rounded-xl px-4 py-2 text-sm text-text-primary focus:ring-4 focus:ring-primary-500/10 outline-none transition-all cursor-pointer"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-surface-main border border-edu-border rounded-xl px-4 py-2 text-sm text-text-primary focus:ring-4 focus:ring-primary-500/10 outline-none transition-all"
                    />
                </div>
            </div>
            ...
            {/* Student Entries */}
            <div className="bg-surface-card rounded-[2rem] shadow-premium overflow-hidden border border-edu-border">
                <div className="px-6 py-4 bg-surface-main/30 border-b border-edu-border flex justify-between items-center">
                        ...
                        {students.map(s => (
                            <div key={s.id} className="flex items-center justify-between px-6 py-4 hover:bg-surface-main/30 transition-colors group">
                                ...
                                <input
                                    ...
                                    className="w-24 bg-surface-main border border-edu-border rounded-xl px-3 py-2 text-sm text-center text-text-primary font-black focus:ring-4 focus:ring-primary-500/10 outline-none transition-all placeholder:text-text-muted/50"
                                />
                            </div>
                        ))}
                    </div>
