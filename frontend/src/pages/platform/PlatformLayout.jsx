    ...
    return (
        <div className="flex h-screen bg-surface-main font-sans text-text-primary overflow-hidden">
            ...
            <aside className="w-64 bg-slate-900 text-white shadow-xl flex flex-col">
                <div className="p-8 border-b border-border-subtle flex items-center gap-4">
            ...
            <main className="flex-1 overflow-auto bg-slate-50">
                <header className="h-20 bg-surface-card border-b border-border-subtle px-10 flex items-center justify-between shadow-premium sticky top-0 z-10">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="w-12 h-12 rounded-2xl bg-surface-main border border-border-subtle flex items-center justify-center shadow-inner group cursor-help transition-transform hover:scale-105">
