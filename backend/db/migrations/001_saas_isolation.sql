...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='users' AND column_name='tenant_id') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_users_org_id ON users(tenant_id);
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='roles' AND column_name='tenant_id') THEN
        ...
        ALTER TABLE roles ADD CONSTRAINT roles_name_org_unique UNIQUE (name, tenant_id);
        CREATE INDEX IF NOT EXISTS idx_roles_org_id ON roles(tenant_id);
    END IF;

    -- attendance
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='attendance' AND column_name='tenant_id') THEN
        ALTER TABLE attendance ADD COLUMN tenant_id UUID REFERENCES organizations(id);
        CREATE INDEX IF NOT EXISTS idx_attendance_org_id ON attendance(tenant_id);
    END IF;

    -- marks
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='marks' AND column_name='tenant_id') THEN
        ALTER TABLE marks ADD COLUMN tenant_id UUID REFERENCES organizations(id);
        CREATE INDEX IF NOT EXISTS idx_marks_org_id ON marks(tenant_id);
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='departments' AND column_name='tenant_id') THEN
        ...
        ALTER TABLE departments ADD CONSTRAINT departments_code_org_unique UNIQUE (code, tenant_id);
        CREATE INDEX IF NOT EXISTS idx_departments_org_id ON departments(tenant_id);
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='courses' AND column_name='tenant_id') THEN
        ...
        ALTER TABLE courses ADD COLUMN tenant_id UUID REFERENCES organizations(id);
        ALTER TABLE courses ADD CONSTRAINT courses_code_org_unique UNIQUE (code, tenant_id);
        CREATE INDEX IF NOT EXISTS idx_courses_org_id ON courses(tenant_id);
    END IF;

    -- classes
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='classes' AND column_name='tenant_id') THEN
        ALTER TABLE classes ADD COLUMN tenant_id UUID REFERENCES organizations(id);
        CREATE INDEX IF NOT EXISTS idx_classes_org_id ON classes(tenant_id);
    END IF;
END $$;
